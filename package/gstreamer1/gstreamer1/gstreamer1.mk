...
define GSTREAMER1_APPLY_GSTWEBRTC_PATCHES_POST_HOOK
        cd $(@D) && { for P in $(TOPDIR)/$(GSTREAMER1_PKGDIR)/$(GSTREAMER1_VERSION)-gstwebrtc/*.patch; do patch -p1 < "$$P" ; done; }
endef
GSTREAMER1_POST_PATCH_HOOKS += GSTREAMER1_APPLY_GSTWEBRTC_PATCHES_POST_HOOK
endif
