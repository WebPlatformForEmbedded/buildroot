...
#
################################################################################
WPEFRAMEWORK_RDKSERVICES_VERSION = b979ee86b39292053e14819ef1fe962fe2989f7a
...
WPEFRAMEWORK_CDMI_USER_GROUP=ocdm
else
WPEFRAMEWORK_CDMI_USER_GROUP=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_GROUP)")
endif
WPEFRAMEWORK_CDMI_USER=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_USER)") -1 $(WPEFRAMEWORK_CDMI_USER_GROUP) -1 * - - root,$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_GROUP)") opencdm
WPEFRAMEWORK_CDMI_PERMISSION=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_DATA_PATH)")/OCDM d 0550 root $(subst ",,$(WPEFRAMEWORK_CDMI_USER_GROUP)") - - - - -
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_CDMI_GROUP),"")
...
WPEFRAMEWORK_WEBKITBROWSER_USER=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_WEBKITBROWSER_USER)") -1 $(WPEFRAMEWORK_WEBKITBROWSER_USER_GROUP) -1 * - - $(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_PLATFORM_VIDEO_DEVICE_GROUP)"),$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_GROUP)"),$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_GROUP)") webkit browser
WPEFRAMEWORK_WEBKITBROWSER_PERMISSION=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_DATA_PATH)")/WebKitBrowser d 0550 root $(subst ",,$(WPEFRAMEWORK_WEBKITBROWSER_USER_GROUP)") - - - - -
endif
