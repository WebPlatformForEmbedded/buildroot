...
WPEFRAMEWORK_PERSISTENT_PERMISSION=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_PERSISTENT_PATH)/Thunder") d 0770 root $(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_GROUP)") - - - - -
...
WPEFRAMEWORK_CONF_OPTS += -DBLUETOOTH=ON
...
ifeq ($(BR2_PACKAGE_RPI_BT_FIRMWARE),y)
ifeq ($(BR2_TOOLCHAIN_HEADERS_AT_LEAST_6_1),y)
WPEFRAMEWORK_CONF_OPTS += -DBCM43XX=OFF
else
WPEFRAMEWORK_CONF_OPTS += -DBCM43XX=ON
endif
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTH_GATT),y)
WPEFRAMEWORK_CONF_OPTS += -DBLUETOOTH_GATT_SUPPORT=ON
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTH_AUDIO),y)
WPEFRAMEWORK_CONF_OPTS += -DBLUETOOTH_AUDIO_SUPPORT=ON
WPEFRAMEWORK_DEPENDENCIES += sbc
endif
endif
...
define WPEFRAMEWORK_POST_TARGET_INITD
	...
	$(INSTALL) -D -m 0755 $(WPEFRAMEWORK_PKGDIR)/S80Thunder $(TARGET_DIR)/etc/init.d/S40Thunder
endef
else
define WPEFRAMEWORK_POST_TARGET_INITD
	mkdir -p $(TARGET_DIR)/etc/init.d
	$(INSTALL) -D -m 0755 $(WPEFRAMEWORK_PKGDIR)/S80Thunder $(TARGET_DIR)/etc/init.d
endef
endif
endif
