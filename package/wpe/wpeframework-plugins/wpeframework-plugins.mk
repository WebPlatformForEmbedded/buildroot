...
WPEFRAMEWORK_PLUGINS_OPKG_DESCRIPTION = "Thunder plugins"
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_AVS_STARTMODE),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AVS_STARTMODE=$(BR2_PACKAGE_WPEFRAMEWORK_AVS_STARTMODE)
endif
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_BACKOFFICE_STARTMODE),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BACKOFFICE_STARTMODE=$(BR2_PACKAGE_WPEFRAMEWORK_BACKOFFICE_STARTMODE)
endif
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DTHUNDER_PLUGIN_COBALT_STARBOARD_CONFIGURATION_INCLUDE="third_party/starboard/wpe/shared/configuration_public.h"
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_COBALT_STARTMODE),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COBALT_STARTMODE=$(BR2_PACKAGE_WPEFRAMEWORK_COBALT_STARTMODE)
endif
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTH_STARTMODE),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTH_STARTMODE=$(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTH_STARTMODE)
endif
...
WPEFRAMEWORK_PLUGINS_DEPENDENCIES += bluez5_utils-headers
endif
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO_CONTROLLER="BluetoothControl"
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO_SINK=ON
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO_SINK_LATENCY=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIOSINK_LATENCY}
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK_CODECSBC), y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO_SINK_CODECSBC=ON
...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK_SDPSERVICE), y)
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO_SOURCE=ON

WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO_SOURCE_CONNECTOR=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SOURCE_CONNECTOR}
...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SOURCE_SDPSERVICE), y)
# This is not an error, these settings are seen from the remote device perspective.
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_WEBPA_STARTMODE),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_WEBPA_STARTMODE=$(BR2_PACKAGE_WPEFRAMEWORK_WEBPA_STARTMODE)
endif
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_POWER_STARTMODE),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_POWER_STARTMODE=$(BR2_PACKAGE_WPEFRAMEWORK_POWER_STARTMODE)
endif
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_PLUGINPROCESSCONTAINERS_STARTMODE),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_PROCESSCONTAINERS_STARTMODE=$(BR2_PACKAGE_WPEFRAMEWORK_PLUGINPROCESSCONTAINERS_STARTMODE)
endif
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_PROCESSMONITOR),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_PROCESSMONITOR=ON
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_PROCESSMONITOR_STARTMODE),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_PROCESSMONITOR_STARTMODE=$(BR2_PACKAGE_WPEFRAMEWORK_PROCESSMONITOR_STARTMODE)
endif
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_SPARK_STARTMODE),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_SPARK_STARTMODE=$(BR2_PACKAGE_WPEFRAMEWORK_SPARK_STARTMODE)
endif
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_COMPOSITOR_STARTMODE),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_STARTMODE=$(BR2_PACKAGE_WPEFRAMEWORK_COMPOSITOR_STARTMODE)
endif
ifeq ($(BR2_PACKAGE_HAS_NEXUS),y)
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DTHUNDER_CREATE_IPKG_TARGETS=ON
