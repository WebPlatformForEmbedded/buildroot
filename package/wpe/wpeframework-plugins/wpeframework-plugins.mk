...
#
################################################################################
WPEFRAMEWORK_PLUGINS_VERSION = cb168506312b714a900e2c071cc7a84a6a2181ad
...
WPEFRAMEWORK_COBALT_USER=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_COBALT_USER)") -1 $(WPEFRAMEWORK_COBALT_USER_GROUP) -1 * - - $(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_PLATFORM_VIDEO_DEVICE_GROUP)"),$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_GENERAL_GROUP)"),$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_GROUP)") cobalt
endif
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_GENERAL_GROUP), "")
