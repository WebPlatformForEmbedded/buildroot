...
WPEFRAMEWORK_COBALT_USER=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_COBALT_USER)") -1 $(WPEFRAMEWORK_COBALT_USER_GROUP) -1 * - - $(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_PLATFORM_VIDEO_DEVICE_GROUP)"),$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_GROUP)"),$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_GROUP)") cobalt
endif
