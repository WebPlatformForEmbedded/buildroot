...
WPEFRAMEWORK_PLUGINS_VERSION = 5fc029462cb8651c0f9ea22022311b8b11ed9bcf 
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PORT=$(BR2_PACKAGE_WPEFRAMEWORK_PORT) -DPLUGIN_DIALSERVER_INTERFACE="0.0.0.0"
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_COBALT_MANUFACTURER_NAME),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COBALT_MANUFACTURER_NAME=$(BR2_PACKAGE_WPEFRAMEWORK_COBALT_MANUFACTURER_NAME)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_COBALT_CHIPSET_MODEL_NUMBER),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COBALT_CHIPSET_MODEL_NUMBER=$(BR2_PACKAGE_WPEFRAMEWORK_COBALT_CHIPSET_MODEL_NUMBER)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_COBALT_FIRMWARE_VERSION),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COBALT_FIRMWARE_VERSION=$(BR2_PACKAGE_WPEFRAMEWORK_COBALT_FIRMWARE_VERSION)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_COBALT_MODEL_NAME),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COBALT_MODEL_NAME=$(BR2_PACKAGE_WPEFRAMEWORK_COBALT_MODEL_NAME)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_COBALT_MODEL_YEAR),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COBALT_MODEL_YEAR=$(BR2_PACKAGE_WPEFRAMEWORK_COBALT_MODEL_YEAR)
endif
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_DIALSERVER_WEBSERVER_CALLSIGN="WebServer"
...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_AMAZON),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_DIALSERVER_ENABLE_AMAZON_PRIME=ON
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_DIALSERVER_AMAZON_PRIME_MODE_ACTIVE),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_DIALSERVER_AMAZON_PRIME_MODE="active"
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_DIALSERVER_AMAZON_PRIME_CALLSIGN),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_DIALSERVER_AMAZON_PRIME_CALLSIGN="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_DIALSERVER_AMAZON_PRIME_CALLSIGN))"
endif
endif
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_DIALSERVER_AMAZON_PRIME_MODE_PASSIVE),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_DIALSERVER_AMAZON_PRIME_MODE="passive"
endif
endif
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_IOCONNECTOR_PIN1_IO),)
    WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_IOCONNECTOR_PIN1_ID=${BR2_PACKAGE_WPEFRAMEWORK_IOCONNECTOR_PIN1_ID}
    WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_IOCONNECTOR_PIN1_MODE=${BR2_PACKAGE_WPEFRAMEWORK_IOCONNECTOR_PIN1_MODE}
    WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_IOCONNECTOR_PIN1_STATE=${BR2_PACKAGE_WPEFRAMEWORK_IOCONNECTOR_PIN1_STATE}
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_IOCONNECTOR_PIN2_IO),)
    WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_IOCONNECTOR_PIN2_ID=${BR2_PACKAGE_WPEFRAMEWORK_IOCONNECTOR_PIN2_ID}
    WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_IOCONNECTOR_PIN2_MODE=${BR2_PACKAGE_WPEFRAMEWORK_IOCONNECTOR_PIN2_MODE}
    WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_IOCONNECTOR_PIN2_STATE=${BR2_PACKAGE_WPEFRAMEWORK_IOCONNECTOR_PIN2_STATE}
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_IOCONNECTOR_PIN3_IO),)
    WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_IOCONNECTOR_PIN3_ID=${BR2_PACKAGE_WPEFRAMEWORK_IOCONNECTOR_PIN3_ID}
    WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_IOCONNECTOR_PIN3_MODE=${BR2_PACKAGE_WPEFRAMEWORK_IOCONNECTOR_PIN3_MODE}
    WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_IOCONNECTOR_PIN3_STATE=${BR2_PACKAGE_WPEFRAMEWORK_IOCONNECTOR_PIN3_STATE}
endif
endif
...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_MONITOR_COBALT),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COBALT_MEMORYLIMIT=${BR2_PACKAGE_WPEFRAMEWORK_MONITOR_COBALT}
endif
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_CDMI_WIDEVINE_PRODUCT_NAME),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += \
    -DPLUGIN_OPENCDMI_WIDEVINE_PRODUCT_NAME="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_WIDEVINE_PRODUCT_NAME))"
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_CDMI_WIDEVINE_COMPANY_NAME),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += \
    -DPLUGIN_OPENCDMI_WIDEVINE_COMPANY_NAME="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_WIDEVINE_COMPANY_NAME))"
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_CDMI_WIDEVINE_MODEL_NAME),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += \
    -DPLUGIN_OPENCDMI_WIDEVINE_MODEL_NAME="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_WIDEVINE_MODEL_NAME))"
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_CDMI_WIDEVINE_DEVICE_NAME),"")
WPEFRAMEWORK_PLUGINS_CONF_OPTS += \
    -DPLUGIN_OPENCDMI_WIDEVINE_DEVICE_NAME="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_WIDEVINE_DEVICE_NAME))"
endif
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_OPENCDMI_PLAYREADY_METERING_CERTIFICATE="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_CDMI_PLAYREADY_SECURE_STOP_METERING_CERTIFICATE))"
endif
endif
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_WEBKITBROWSER_ALTERNATIVE_EXEC_PATH="$(call qstrip,$(BR2_PACKAGE_WPEWEBKIT_ALTERNATIVE_EXEC_PATH))"
endif
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_TAB),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_HYBRID=ON
endif
...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_WEBKITBROWSER_MSEBUFFERS),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_WEBKITBROWSER_MSEBUFFERS=$(BR2_PACKAGE_WPEFRAMEWORK_WEBKITBROWSER_MSEBUFFERS)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_WEBKITBROWSER_INSPECTOR),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_WEBKITBROWSER_WEBINSPECTOR_ADDRESS=$(BR2_PACKAGE_WPEFRAMEWORK_WEBKITBROWSER_INSPECTOR)
endif
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_CADIRECTORYPATH=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_CA_DIRECTORY_PATH)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_CA_BUNDLE_FILENAME),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_CABUNDLEFILENAME=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_CA_BUNDLE_FILENAME)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_MANUFACTURER),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_MANUFACTURER=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_MANUFACTURER)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_MODELNAME),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_MODELNAME=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_MODELNAME)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_DEVICELANGUAGE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_DEVICELANGUAGE=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_DEVICELANGUAGE)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_DEVICETYPEID),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_DEVICETYPEID=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_DEVICETYPEID)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_FIRMWARE_VERSION),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_FIRMWAREVERSION=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_FIRMWARE_VERSION)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_CHIPSET_NAME),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_CHIPSETNAME=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_CHIPSET_NAME)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_ETHERNET_DEVICE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_ETHERNETDEVICE=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_ETHERNET_DEVICE)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_FRAGMENT_CACHE_SIZE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_FRAGMENTCACHESIZE=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_FRAGMENT_CACHE_SIZE)
endif
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_MEMORYPROFILE=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_MEMORYPROFILE)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_MEMORYPRESSURE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_AMAZON_MEMORYPRESSURE=$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_MEMORYPRESSURE)
endif
...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_PLAYERINFO_DOLBY_SUPPORT),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_PLAYERINFO_DOLBY_SUPPORT=$(BR2_PACKAGE_WPEFRAMEWORK_PLAYERINFO_DOLBY_SUPPORT)
ifeq  ($(BR2_PACKAGE_HAS_NEXUS),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_PLAYERINFO_DOLBY_IMPLEMENTATION=Nexus
endif
# TODO: add AMlogic definitions
endif
endif
