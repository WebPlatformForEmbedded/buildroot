...
WPEFRAMEWORK_PLUGINS_VERSION = ef787ff61ee83e1b1431fb337e5caae02c1fce1f
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_SECURESHELLSERVER=ON
ifeq ($(BR2_PACKAGE_DROPBEAR_LIB),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_SECURESHELLSERVER_IMPLEMENTATION=Dropbear
WPEFRAMEWORK_DEPENDENCIES += dropbear
else
$(error Missing a secureshellserver implemtation, please provide one or disable PLUGIN_SECURESHELLSERVER)
endif
endif
