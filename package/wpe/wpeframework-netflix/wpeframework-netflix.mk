...
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_STARTMODE),"")
WPEFRAMEWORK_NETFLIX_CONF_OPTS += -DPLUGIN_NETFLIX_STARTMODE=$(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_NETFLIX_STARTMODE)
endif
...
WPEFRAMEWORK_NETFLIX_USER=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_NETFLIX_USER)") -1 $(WPEFRAMEWORK_NETFLIX_USER_GROUP) -1 * - - $(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_PLATFORM_VIDEO_DEVICE_GROUP)"),$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_GROUP)")$(WPEFRAMEWORK_CDMI_GROUP) netflix
WPEFRAMEWORK_NETFLIX_PERMISSION=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_INSTALL_PATH)")/Netflix r 0550 root $(subst ",,$(WPEFRAMEWORK_NETFLIX_USER_GROUP)") - - - - -
endif

ifneq ($(WPEFRAMEWORK_NETFLIX_USER_GROUP),"")
WPEFRAMEWORK_NETFLIX_CONF_OPTS += -DPLUGIN_NETFLIX_GROUP=$(WPEFRAMEWORK_NETFLIX_USER_GROUP)
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_CREATE_IPKG_TARGETS),y)

WPEFRAMEWORK_NETFLIX_CONF_OPTS += -DPLUGINS_CREATE_IPKG_TARGETS=ON
