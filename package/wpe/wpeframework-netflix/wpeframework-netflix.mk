...
WPEFRAMEWORK_NETFLIX_USER=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_NETFLIX_USER)") -1 $(WPEFRAMEWORK_NETFLIX_USER_GROUP) -1 * - - video,$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_GENERAL_GROUP)") netflix
endif
