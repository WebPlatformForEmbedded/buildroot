...
define WPEFRAMEWORK_AMAZON_USERS
	$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_USER)) -1 $(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_AMAZON_GROUP)) -1 * - - video,$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_GENERAL_GROUP)),video amazon prime
endef
